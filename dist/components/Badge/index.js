...
var Badge = function (_a) {
    ...
    if (!children)
        return null;
    return (0, jsx_runtime_1.jsx)("div", __assign({ className: "my-2 rounded-full w-fit px-4 py-1 text-[10pt] font-semibold ".concat(bg, " ").concat(text, " ").concat(className) }, { children: children }));
};
exports.Badge = Badge;
