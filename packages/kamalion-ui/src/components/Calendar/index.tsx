...
function Calendar({
  ...
  const _selectedClassName = cn(
    "[&>button]:!bg-(--calendar-selected-background) [&>button]:!text-(--calendar-selected-foreground)",
  ...
  return (
    <DayPicker
      ...
      className={cn("p-3 bg-(--calendar-background) text-(--calendar-foreground)", className)}
      locale={ptBR}
      style={{
